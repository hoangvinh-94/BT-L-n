...
</title><link href="./files/show_img.css" rel="stylesheet" type="text/css">
    <script type="text/javascript" src="./files/jquery-1.7.2.min.js.tải xuống"></script>
    <script src="./files/Common.js.tải xuống" type="text/javascript"></script>
    <script src="./files/PagingContent.js.tải xuống" type="text/javascript"></script>
<link rel="shortcut icon" type="image/png" href="http://icsse2017.hcmute.edu.vn/Resources/Imagephoto/logo.png"><link href="./files/lightbox.css" rel="stylesheet" type="text/css">
    <script src="./files/lightbox.min.js.tải xuống" type="text/javascript"></script>
    <link href="./files/search_Article.css" rel="stylesheet">
...
<link href="./files/WebResource.axd" type="text/css" rel="stylesheet" class="Telerik_stylesheet"><link href="./files/WebResource(1).axd" type="text/css" rel="stylesheet" class="Telerik_stylesheet"><link href="./files/WebResource(2).axd" type="text/css" rel="stylesheet" class="Telerik_stylesheet"></head>
...
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="/wEPaA8FDzhkNDc3YTcwMTAzOGY4MBgBBR5fX0NvbnRyb2xzUmVxdWlyZVBvc3RCYWNrS2V5X18WAgURUmFkV2luZG93TWFuYWdlcjEFOmN0bDA2JHBvcnRsZXRfODAwODg2YTgtY2NiNS00MGRkLTgxM2EtMmMwMmFjMGQyZTkyJFJhZE1lbnW8Q3iZO4AjvpqV5KGk8fWaNIQpKw==">
</div>
...
<script src="./files/WebResource(3).axd" type="text/javascript"></script>


<script src="./files/Telerik.Web.UI.WebResource.axd" type="text/javascript"></script>
<script type="text/javascript">
//<![CDATA[
...
<script src="./files/jsdebug" type="text/javascript"></script>
<script src="./files/jsdebug(1)" type="text/javascript"></script>
<script src="./files/jsdebug(2)" type="text/javascript"></script>
<script src="./files/jsdebug(3)" type="text/javascript"></script>
<div>
...
<link href="./files/mainPortlets.css" rel="stylesheet">
<script language="javascript" type="text/javascript">
    function SearchProcess(event) {
        if (event.keyCode == 13) {
            OnSearch(document.getElementById('txtSearchArticle').value);
		...
		<td colspan="2"><div id="pnTop">
			<div id="pnTopDisplay" style="width:1000px;float:left">
				<div id="ctl06_portlet_83a3e05a-eb99-4512-bd1a-5af90706fcf3" style="width:574px;float:left"><div>
					<div class="P_top">
<div class="P_logo">
<div class="anh_logo"><img alt="" src="./files/Banner Hoi nghi quoc te sua.jpg" style="width: 800px; height: 188px;"><br>
</div>
<div class="name_ute">
</div>
</div>
...
<link href="./files/nivo-slider.css" rel="stylesheet">
<link href="./files/default.css" rel="stylesheet">

<script src="./files/jquery.nivo.slider.js.tải xuống"></script>
...
<div class="container" style="height:350px;">
    <div class="slider-wrapper theme-default">
        ...
        <a href="http://icsse2017.hcmute.edu.vn/" target="_blank" class="nivo-imageLink" style="display: none;">
                <img src="./files/HNQT3.jpg" title="" style="height: 350px; width: 1000px; visibility: hidden; display: inline;"></a>
    
        <a href="http://icsse2017.hcmute.edu.vn/" target="_blank" class="nivo-imageLink" style="display: block;">
                <img src="./files/HNQT2.jpg" title="" style="height: 350px; width: 1000px; visibility: hidden; display: inline;"></a>
    
        <a href="http://icsse2017.hcmute.edu.vn/" target="_blank" class="nivo-imageLink" style="display: none;">
                <img src="./files/HNQT1.jpg" title="" style="height: 350px; width: 1000px; visibility: hidden; display: inline;"></a>
    
        <img class="nivo-main-image" src="./files/HNQT2.jpg" style="display: inline; height: auto; width: 1000px;"><div class="nivo-caption"></div><div class="nivo-directionNav"><a class="nivo-prevNav">Prev</a><a class="nivo-nextNav">Next</a></div></div><div class="nivo-controlNav"><a class="nivo-control" rel="0">1</a><a class="nivo-control active" rel="1">2</a><a class="nivo-control" rel="2">3</a></div>
    </div>
</div>
<script>
...
<link href="./files/Menu.Green.css" rel="stylesheet" type="text/css">
...
<div class="thongbao_phong">
    <div class="topictb_phong_blue">
        ...
        <a class="wobble-horizontal" href="http://icsse2017.hcmute.edu.vn/?TopicId=31ca0f13-71be-4bd9-ad28-d3589a3cf6d2">
            <img src="./files/arrow_all_phong.png"></a>
    </div>
...
<div class="truycap_ute">
    <p>Visit month:
        <span id="ctl06_portlet_5c231c9e-b9b3-474f-bb01-834b95465666_Label4">4,575</span></p>
    <p class="line_footer"></p>
    <p>Visit total:<span id="ctl06_portlet_5c231c9e-b9b3-474f-bb01-834b95465666_Label1">8,053</span></p>
</div>
